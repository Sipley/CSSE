...
# If input {'op': 'predict'}, return {'op': 'predict'}
 ...
 #       self.assertDictEqual(sighting, result)
    ...
    def test100_020_shouldReturnAlt(self):
        ...
        result = dispatch.dispatch(sighting)
        expectedResult = {'altitude':'41d59.1', 'observation': '42d0.0',  'op': 'adjust'}
        self.assertDictEqual(result, expectedResult)

    def test100_030_shouldReturnSameAlt(self):
        sighting = {'observation': '42d0.0',  'op': 'adjust', 'extraKey':'ignore'}
        result = dispatch.dispatch(sighting)
        expectedResult = {'altitude':'41d59.1', 'observation': '42d0.0',  'op': 'adjust', 'extraKey':'ignore'}
        self.assertDictEqual(result, expectedResult)
    ...
    def test100_040_shouldReturnAltWithParm(self):
        ...
        result = dispatch.dispatch(sighting)
        expectedResult = {'altitude':'30d0.2', 'observation': '30d1.5', 'height': '19.0', 'pressure': '1000', 'horizon': 'artificial', 'op': 'adjust', 'temperature': '85'}
        self.assertDictEqual(result, expectedResult)

    def test100_050_shouldReturnCorrectAlt(self):
        sighting = {'observation': '45d15.2', 'height': '6', 'pressure': '1010', 'horizon': 'natural', 'op': 'adjust', 'temperature': '71'}
        result = dispatch.dispatch(sighting)
...
# SAD PATH
    ...
    def test900_350_shouldReturnErrorDegreeNotFloat(self):
        ...
        result = dispatch.dispatch(sighting)
        expectedResult = {'error':'observation is invalid','op':'adjust','observation':'0d1'}
        self.assertDictEqual(result, expectedResult)
    ...
    def test900_370_shouldReturnErrorInvH(self):
        sighting = {'op':'adjust','observation': '45d15.2', 'height':''}
        result = dispatch.dispatch(sighting)
